        ...
        switch ($_POST['action']) {
            ...
            case 'fill_pdf':
                if (isset($_SESSION['uploaded_pdf'])) {
                    // Qui andrà la logica per compilare il PDF
                    include 'fill_pdf.php';
                }
                break;
        }
    }
...
if (isset($_SESSION['uploaded_pdf'])) {
    $uploaded_pdf = $_SESSION['uploaded_pdf'];
}
?>
<!DOCTYPE html>
<html lang="it">
<head>
    ...
    <title>ASD Allin Kickboxing - Gestione PDF</title>
